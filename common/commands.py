...
COMMAND_AOT_DEBTORS, COMMAND_AOT_FREE_APART, COMMAND_AOT_DEBTORS_NO_BALANCE, COMMAND_AOT_TENANT, \
COMMAND_AOT_LIVING, COMMAND_AOT_SHORT_STAY, COMMAND_AOT_OUT, COMMAND_AOT_SEND, \
COMMAND_AOT_TOTAL_DEBTORS = __get_command_acronyms()
