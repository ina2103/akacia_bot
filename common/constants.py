...
TEMPLATE_TENANT_LASTNAME = "Укажите фамилию"
TEMPLATE_TENANT_NAME = "Укажите имя"
TEMPLATE_TENANT_LANGUAGE = "Выберите язык, на котором пользователь будет получать рассылку"
TEMPLATE_TENANT_TELEGRAM_NONE = "У пользователя отсутствует никнейм, регистрация невозможна. Надо попросить его завести имя, которое через @"
