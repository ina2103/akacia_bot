...
TEMPLATE_TENANT_LASTNAME = "Укажите фамилию (можно выбрать предложенную или в поле диалога написать другую)."
TEMPLATE_TENANT_NAME = "Укажите имя (можно выбрать предложенную или в поле диалога написать другую)."
