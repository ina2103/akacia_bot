...
WAITING_YES_NO = 341
WAITING_CONTACT = 342
WAITING_TENANT_NAME = 343
WAITING_TENANT_LASTNAME = 344
...
TEMPLATE_TENANT_WELCOME = {
    LANGUAGE_RU: "Привет, {}! у нас есть бот, который присылает актуальную информацию по начислениям за аренду и коммуналку. Подпишись на @akacia_bot",
...
TEMPLATE_TENANT_GOODBYE = {
    ...
    LANGUAGE_EN: "Thank you for stayed with us. Hope to see you again ❤️"
}
...
TEMPLATE_INPUT_ERROR = "Ошибка ввода. Попробуйте еще раз. Я в вас верю!"
TEMPLATE_MANAGER_NO_PERMISSION = "У вас нет прав на выполнение этой команды"
TEMPLATE_ERROR_IN_APART = "Неверный номер квартиры"
...
TEMPLATE_NO_CASHBOXES = "Кассы не найдены 🤷‍♂️"
...
"Для вирутальной оплаты используйте\n '0 пробел сумма'"
...
TEMPLATE_TOTAL_DEBTORS_ADM = ("С начала времен и по сегодня больше €100 задолжали (в порядке убывания наглости):\n\n")
TEMPLATE_TOTAL_DEBTORS_ROW = "— {}, @{}, {:.0f}€\n"
...
# Регистарция проживаний
TEMPLATE_FREE_APART_HEADER = "Свободные квартиры\n"
TEMPLATE_FREE_APART_ADM = ("<b>{}</b>:\n")
TEMPLATE_FREE_APART_ROW = "— {} этаж: {}\n"
TEMPLATE_TENANT_OUT = "Оформить выезд жильца <b>{}</b> из квартиры <b>{}</b>?"
TEMPLATE_NO_TENANT = "В квартире <b>{}</b> никто не проживает. Проверьте указанный номер или обратитесь к администратору базы данных.\n"
...
TEMPLATE_TENANT_TELEGRAM = "Отправьте контакт нового жильца в телеграме для автоматического определения ника, имени и фамилии."
TEMPLATE_TENANT_LASTNAME = "Введите фамилию"
TEMPLATE_TENANT_NAME = "Введите имя"
TEMPLATE_TENANT_LANGUAGE = "Выберите язык, на котором пользователь будет получать рассылку"
TEMPLATE_TENANT_LANG_ERROR = "Выбран неверный язык\n" + TEMPLATE_TENANT_LANGUAGE
TEMPLATE_TENANT_TELEGRAM_NONE = "У пользователя отсутствует никнейм, регистрация невозможна. Попросите его завести имя, которое через @"
TEMPLATE_TENANT_ADDED = "<b>{} {}</b> добавлен в список жильцов, перешлите ему следующее сообщение.\nЕсли хотите добавить долгосрочное проживание, нажмите /living"
TEMPLATE_TENANT_NOT_FOUND = "Человек с таким ником не найден в базе. Выполните команду /tenant"
TEMPLATE_SHORT_STAY_APART = "Выберите квартиру"
TEMPLATE_LIVING_PRICE = "Введите стоимость проживания. Стоимость по прайсу <b>{:.0f}€</b>"
TEMPLATE_LIVING_DAYS = "Введите количество дней проживания"
TEMPLATE_NEW_SHORT_STAY = "Добавлено новое краткосрочное проживание:\n С <b>{}</b> по <b>{}</b> в квартире <b>{}</b> зарегистрирован <b>{} {}</b>. Автоматически начислена аренда <b>{:.0f}€</b>"
TEMPLATE_NEW_LONG_STAY = "Новый жилец в Акации:\n С <b>{}</b> в квартире <b>{}</b> проживает <b>{}</b>. Автоматически начислена аренда <b>{:.0f}€</b>"
TEMPLATE_SEND = "Ежемесячная рассылка только за текущий месяц. Произвольная - любой текст всем актуальным жильцам"
TEMPLATE_SENDED = "Рассылка завершена 🥳"
TEMPLATE_SEND_ARBITRARY_TEXT = "Ну давай, удиви меня 🤨"
